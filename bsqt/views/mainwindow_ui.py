...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.latest_before_frame = QFrame(self.latest)
        self.latest_before_frame.setObjectName(u"latest_before_frame")
        self.latest_before_frame.setFrameShape(QFrame.Shape.StyledPanel)
        self.latest_before_frame.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_2 = QHBoxLayout(self.latest_before_frame)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.latest_before_label = QLabel(self.latest_before_frame)
        self.latest_before_label.setObjectName(u"latest_before_label")

        self.horizontalLayout_2.addWidget(self.latest_before_label)

        self.latest_date_edit = QDateTimeEdit(self.latest_before_frame)
        self.latest_date_edit.setObjectName(u"latest_date_edit")
        sizePolicy1.setHeightForWidth(self.latest_date_edit.sizePolicy().hasHeightForWidth())
        self.latest_date_edit.setSizePolicy(sizePolicy1)

        self.horizontalLayout_2.addWidget(self.latest_date_edit)


        self.latest_date_layout.addWidget(self.latest_before_frame)
        ...
        self.verticalLayout_3.addWidget(self.latest_sort_frame)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 513, 385))
